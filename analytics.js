...
const MOCK_DATA = {
  ssc: {
    ...
    cbas: createSSCCampusData("CBAS"),
    muzon: createSSCCampusData("Muzon"),
    francisco: createSSCCampusData("Francisco"),
  },
  departments: Object.fromEntries(
    Object.keys(DEPARTMENTS).map((code) => [
      code,
      {
        ...
        cbas: createDepartmentData(code, "CBAS"),
        muzon: createDepartmentData(code, "Muzon"),
        francisco: createDepartmentData(code, "Francisco"),
      },
    ]),
  ),
};
...
function getChartTitle(chartId) {
  const baseChartId = chartId.replace(/-(college|cbas|muzon|francisco)$/, "");
